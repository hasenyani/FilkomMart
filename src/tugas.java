...
public class tugas {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("%dx @%-10s %18s\n", jumlah1, harga1, "\tRp " + total1);
        System.out.println(namaBarang2);
        System.out.printf("%dx @%-10s %18s\n", jumlah2, harga2, "\tRp " + total2);
        System.out.println(namaBarang3);
        System.out.printf("%dx @%-10s %18s\n", jumlah3, harga3, "\tRp " + total3);
        System.out.println(namaBarang4);
        System.out.printf("%dx @%-10s %18s\n", jumlah3, harga4, "\tRp " + total4);
        ...
        if (diskonPersen > 0) {
            ...
            System.out.println((int)(diskonPersen * 100) + "%                      -Rp. " + formatRupiah(nilaiDiskon));
        }
        ...
        System.out.println("========================================");
        System.out.println("Kembali                - Rp " + formatRupiah(kembalian));
        System.out.println("========================================");
